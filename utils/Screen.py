...
def init():  # 屏幕初始化
    ...
    sendCommand(0xE0, 0x0F, 0x31, 0x2B, 0x0C, 0x0E, 0x08, 0x4E, 0xF1, 0x37, 0x07, 0x10, 0x03, 0x0E, 0x09,
                0x00)  # Set Gamma
    sendCommand(0xE1, 0x00, 0x0E, 0x14, 0x03, 0x11, 0x07, 0x31, 0xC1, 0x48, 0x08, 0x0F, 0x0C, 0x31, 0x36,
                0x0F)  # Set Gamma
...
#setFont = ImageFont.truetype("/usr/share/fonts/myfont/MSYHBD.TTF",32)  # 字体地址，请参考我这篇内容：
